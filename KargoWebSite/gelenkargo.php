  ...
  <div class="text-center">
    <div>
      ...
      <div class="card" style="width:90%">
        <div class="card-header">ADINIZA GELEN KARGOLAR</div>
        <div class="card-body">
        <?php if (isset($_SESSION['kullaniciID'])) { ?>
      <div class="title text-center"><h5>GELEN KARGOLAR</h5></div>
      <table class="table table-bordered">
        <thead>
          <tr>
            ...
            <th>Gonderen TC No</th>
          </tr>
        </thead>
        <tbody>

          <?php
          $query = "SELECT * FROM tblgonderiler WHERE aliciID=".$_SESSION['kullaniciID']."";
